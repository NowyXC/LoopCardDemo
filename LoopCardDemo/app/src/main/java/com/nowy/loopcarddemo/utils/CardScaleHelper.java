package com.nowy.loopcarddemo.utils;
...
public class CardScaleHelper {
    ...
    private PagerSnapHelper mLinearSnapHelper = new PagerSnapHelper();
...
//                mRecyclerView.smoothScrollToPosition(mCurrentItemPos);//平滑滑动
                layoutManager.scrollToPositionWithOffset(mCurrentItemPos,dip2px(mContext,mPagePadding + mShowLeftCardWidth));
    ...
    private void onScrolledChangedCallback() {
        ...
        Log.e("recyclerView","percent:"+percent);
        View leftView = null;
        View currentView;
        View rightView = null;
